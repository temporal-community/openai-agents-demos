...
async def main():
    parser = argparse.ArgumentParser(description="OpenAI Interactive Research Workflow CLI")
    parser.add_argument("query", nargs="?", help="Research query")
    parser.add_argument("--workflow-id", default="interactive-research-workflow", 
