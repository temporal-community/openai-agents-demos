...
class ResearchInteraction:
    ...
    def get_current_question(self) -> Optional[str]:
        ...
        if not self.clarification_questions or self.current_question_index >= len(self.clarification_questions):
            return None
    ...
    def __str__(self):
        questions_progress = f"{self.current_question_index}/{len(self.clarification_questions or [])}"
